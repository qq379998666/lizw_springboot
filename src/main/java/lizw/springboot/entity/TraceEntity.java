...
public class TraceEntity {
    ...
    public TraceEntity(Integer id,Integer hop,String A_ip,String A_country,String A_province,String A_city,String A_operator,String A_p,String B_ip,String B_country,String B_province,String B_city,String B_operator,String B_p,Integer hop_sign){
		this.id = id;
		this.hop = hop;
		this.A_ip = A_ip;
